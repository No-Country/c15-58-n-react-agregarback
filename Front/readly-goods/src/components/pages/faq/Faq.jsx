                ...
                <div className="text-[#525252] p-3">
                  ...
                  <ol className="list-decimal">
                    ...
                    <li>
                      ...
                      gmail. Te recomendamos registrarte así no deberás definir
                      tu dirección de envío la proxima vez que realices una
                      compra. Para esto entra en "Mi cuenta" en la pagina
                      principal.
                    </li>
                    <li>
                      Luego deberás ingresar los datos de facturación con tu
                      nombre, documento de identidad y un teléfono. En caso de
                      necesitar factura con RUT es aquí donde deberás ingresar
                      los datos. También podrás revisar y modificar tu compra.
                      Una vez ingresados los datos da click en CONTINUAR.
                    </li>
                    <li>
                      En la página de datos de envío deberás seleccionar si
                      deseas recibir el pedido en una dirección solicitada o
                      retirar en sucursal. En caso de elegir enviar a dirección,
                      deberás ingresar la dirección en la cual deseas recibir el
                      paquete y luego elegir el método de envío. En caso de
                      seleccionar retiro en sucursal deberás seleccionar en cuál
                      deseas retirar tu paquete.
                    </li>
                    <li>
                    ...
                    <li>
                      Es importante aclarar que el descuento para las tarjetas
                      de Scotiabank NO ES AUTOMÁTICO. Debes seleccionarlo antes
            ...
            <AccordionPanel>
              ...
              <AccordionContent>
                <div className="text-[#525252] p-3">
                  ...
                  <p>
                    En nuestra librería online disponemos de los siguientes
                    medios de pago: tarjetas de crédito Visa, American Express y
                    Oca, e-BROU, BBVA, pago en efectivo al momento de recibir la
                    compra en envíos a Montevideo y depósito en RedPagos. De
                    querer realizar el pago a través de un depósito en RedPagos,
                    se deberá solicitar al 096 646 400 el procedimiento a
                    seguir.
                  </p>
                  <div className="p-1 font-bold">Tarjeta de crédito</div>
                  <p>
                    El pago lo podés realizar tanto con tarjetas nacionales como
                    internacionales. Las compras realizadas con tarjetas de
                    bancos extranjeros no disponen del pago en cuotas. Durante
                    el proceso de compra, al momento del pago nuestra tienda te
                    dirigirá a la pasarela de pago para tu total tranquilidad,
                    esta es totalmente segura, se ejecuta a través de un cifrado
                    SSL de 128 bits. Este sistema encripta los datos
                    suministrados y evita su uso desautorizado. En cuanto
                    registremos la recepción del pago, recibirás una
                    confirmación por correo electrónico y comenzaremos a
                    procesar la compra para despachar. Aprovechá esta forma de
                    pago rápida, segura, sencilla y sin cargos adicionales.
                  </p>
                  <div className="p-1 font-bold">
                    ¿Puedo obtener una factura a nombre de mi empresa?{" "}
                  </div>
                  <p>
                    Si, solamente tienes que marcar la opción de “factura con
                    RUT” en datos de facturación y completar los datos fiscales
                    que solicitamos. ReadlyGoods
                  </p>
                </div>
              </AccordionContent>
            </AccordionPanel>
              ...
              <AccordionContent>
                <div className="text-[#525252] p-3">
                  ...
                  <p>
                    ...
                    librerías en todo el país, previa solicitud, la entrega es
                    sin costo. Los retiros se pueden realizar dentro del horario
                    de atención de cada shopping (consultar Horarios). Una vez
                    hayas finalizado el proceso de compra recibirás una
                    notificación vía mail indicándote los detalles del pedido.
                  </p>
                  <p className="p-1 font-bold">
                    ...
                    hasta 5 días hábiles (sobre todo para locales en el
                    interior).
                  </p>
                  <p>
                    Para la recogida de tu pedido, solo necesitas presentar el
                    correo electrónico que te enviamos con la confirmación de
                    que está preparado en librería, o bien tu CI. Dispones de 7
                    días para recoger tu pedido en librería. Transcurrido este
                    plazo será enviado a Casa Central, Gabriel A. Pereira 3076.
                  </p>
                  <div className="p-1 font-bold">
              ...
              <AccordionContent>
                <div className="text-[#525252] p-3">
                  ...
                  <p>
                    ...
                    libro impreso en cualquier momento y sin ningún costo
