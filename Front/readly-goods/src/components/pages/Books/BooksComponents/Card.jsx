    ...
    <div className="flex flex-col w-full h-full shadow-xl rounded-2xl">
      ...
      <div className="flex flex-col justify-between h-full px-5 pt-2 pb-5 ">
        ...
        <div className="flex items-center justify-between gap-2">
          <p className="text-sm font-bold lg:text-xl text-neutral-900">
            ${price}
          </p>
          <button className="flex items-center px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-neutral-900 hover:bg-neutral-800">
